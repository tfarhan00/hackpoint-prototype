  ...
  return (
    <div>
       <svg id="svg" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 600 1200">
        ...
        <circle class="ball ball01 fill-black" r="20" cx="50" cy="100"></circle>
        <circle class="ball ball02 fill-black" r="20" cx="278" cy="201"></circle>
        <circle class="ball ball03 fill-black" r="20" cx="327" cy="401"></circle>
        <circle class="ball ball04 fill-black" r="20" cx="203" cy="601"></circle>
